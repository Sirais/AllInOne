...
namespace AllInOne.Misc
{
    public class Mouse
    {
        ...
        public static void SetCursorPosAndRightClick(int posX, int posY, int extraDelay)
        {
            SetCursorPos(posX, posY);
            Thread.Sleep(MovementDelay + extraDelay);
        ...
        public static void SetCursorPosAndRightClick(Vector2 coords, int extraDelay)
        {
            int posX = (int)coords.X;
            int posY = (int)coords.Y;
